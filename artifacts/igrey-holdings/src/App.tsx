...
import { ArrowDownRight, ArrowRight, ArrowUpRight, Check, ChevronDown, ChevronUp, Clock3, Compass, Facebook, Home, Instagram, Linkedin, Menu, Quote, ShieldCheck, Sparkles, X } from 'lucide-react';
...
const footerLogo = asset('igrey-footer-logo.png');
...
function HomePage() {
  return <div className="min-h-[100dvh] overflow-hidden bg-[#f6f1e5]">
    ...
    <section id="properties" className="bg-[#e9e1cf] px-5 py-24 lg:px-10 lg:py-32">
      <div className="mx-auto max-w-[1320px]">
        <div className="flex flex-wrap items-end justify-between gap-8"><div><Eyebrow>LISTED PROPERTIES</Eyebrow><h2 className="mt-6 max-w-[650px] font-display text-6xl leading-[.88] text-[#19382f] lg:text-8xl">Available<br /><em>now.</em></h2></div><a href="#properties" className="group inline-flex items-center gap-4 rounded-sm border border-[#19382f]/25 px-6 py-4 font-mono-label text-[10px] tracking-[.13em] text-[#19382f] transition-colors hover:border-[#bd674e] hover:text-[#bd674e]" data-testid="link-view-all-properties">View all properties <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></a></div>
